...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    '/CaseDetailPage': RouteRecordInfo<'/CaseDetailPage', '/CaseDetailPage', Record<never, never>, Record<never, never>>,
    '/CasesListPage': RouteRecordInfo<'/CasesListPage', '/CasesListPage', Record<never, never>, Record<never, never>>,
    '/ContactPage': RouteRecordInfo<'/ContactPage', '/ContactPage', Record<never, never>, Record<never, never>>,
